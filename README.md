...
Product Performance: Ranked product categories and individual SKUs using TopN analysis.

Trend Forecasting: Analyzed Month-over-Month (MoM) and Year-over-Year (YoY) growth patterns.
...
Calculations: Advanced DAX (Data Analysis Expressions) for Time Intelligence and KPI metrics.

Visualization: Slicers, Ribbon Charts, Map Visuals, and Decomposition Trees.
